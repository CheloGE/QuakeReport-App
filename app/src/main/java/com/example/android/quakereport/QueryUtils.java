...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String earthQuakesJson) {
        ...
        try {
            ...
            JSONObject responseJson = new JSONObject(earthQuakesJson);
            ...
            for (int i=0;i<features.length();i++){
                ...
                String urlEarthquake = properties.getString("url");
                long timeInMilliseconds=properties.getLong("time");


                earthquakes.add(new Earthquake(properties.getDouble("mag"),
                        properties.getString("place"),timeInMilliseconds,urlEarthquake));
            }
